...
class HashTable:
    """
    Клас реалізує хеш-таблицю з функцією подвійного хешування, вирішення колізії методом відкритої адресації
    та динамічною зміною розміру таблиці, в залежності від величини коефіцієнту заповнення.
    Також реалізовані функції перевірки даних на коректність.
    """
...
n.set_data("1", "Kofanov")
n.set_data("2", "Kravtsova")
n.set_data("1.5", "Kofanov")
n.set_data("122", "Komisarov")
n.set_data("Svetlana", "Komisarova")
n.set_data("Людмила", "Kofanova")
