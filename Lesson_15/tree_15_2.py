...
class Tree:
    ...
    def findval(self, find_val, node = None):
        if node == None:
            node = self.root
        if node == None:
        ...
        if find_val < node.id_node:
            if node.left is None:
                return str(find_val) + " Not Found"
            return self.findval(find_val, node.left)
        elif find_val > node.id_node:
            if node.right is None:
                return str(find_val) + " Not Found"
            return self.findval(find_val, node.right)
        else:
            if node.right and node.left:
                return node.id_node, node.left.id_node, node.right.id_node
            elif node.left:
                return node.id_node, node.left.id_node, None
            else:
                return node.id_node, None, node.right.id_node
